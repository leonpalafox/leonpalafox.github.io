...
title: "Machine Learning 2 — León Palafox"
description: "The second course in the ML track: advanced supervised and unsupervised methods, model selection, and applied modeling workflows."
heading: "Machine Learning 2"
---
...
| 2 | De Gradiente Descendente a XGBoost | [PDF](/slides/ml2/class-02.pdf) |
| 3 | Stacking, Tuning y Validación Cruzada en Series de Tiempo | [PDF](/slides/ml2/class-03-stacking-tuning-cv.pdf) |
| 4 | Análisis de Componentes Principales (PCA) | [PPTX](/slides/ml2/class-04-pca.pptx) |
| 5 | Reducción No-Lineal — t-SNE y UMAP | [PPTX](/slides/ml2/class-05-tsne-umap.pptx) |
